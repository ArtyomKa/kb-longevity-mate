...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kettlebell Longevity Tracker" },
      {
        name: "description",
        content:
          "Track single and dual kettlebell longevity workouts with rest timers, tempo pacing and biofeedback logging.",
      },
      { name: "theme-color", content: "#181b20" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:title", content: "Kettlebell Longevity Tracker" },
      { property: "og:description", content: "Two-mat kettlebell training, tracked simply." },
